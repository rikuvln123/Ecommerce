...
<body>
	<div class="top-nav-bar">
		<div class="search-box">
			<i class="fa fa-bars" id="menu-btn" onclick="openmenu()"></i> <i
				class="fa fa-times" id="close-btn" onclick="closemenu()"></i> <img
				src="logo.png" class="logo"> <input type="text" name=""
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 feature-box">
					...
					<div class="feature-text">
						<p>
							<b>Return within 10 days</b> of reciveing your order.
						</p>
					</div>
				</div>
				...
				<div class="col-md-3 feature-box">
					...
					<div class="feature-text">
						<p>
							<b>Get free delivary for every</b> order on more then price.
						</p>
					</div>
				</div>
	...
	<section class="footer">
		<div class="container  text-center">
			...
			<hr>
			<h3 class="copright">
				Made by <i class="fa fa-heart-o"></i> <b>Ritesh kumar</b>
			</h3>
		</div>
